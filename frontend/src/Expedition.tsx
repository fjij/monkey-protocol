...
function Location({
  ...
  const secondsLeft = (context.ends.toNumber() - Date.now() / 1000);
  return (
    <>
      <div className="location-wrapper">
        ...
        { context.ongoing && context.area === area && secondsLeft > 0 &&
          <button className="purple-button" disabled={true}>{secondsLeft.toFixed(0)}s</button>
        }
        { context.ongoing && context.area === area && secondsLeft < 0 &&
